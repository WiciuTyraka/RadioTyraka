...
public:
  ...
  bool recvTelemetry(uint8_t *buf, uint8_t *len, uint8_t *headerFirstByte, uint8_t *crc);
  ...
  uint8_t calcCRC(char *str, uint8_t len);

  bool sendBinaryStruct(const uint8_t *data, uint8_t len, bool isTelemetry = true);

  bool sendCharArray(const uint8_t *data, uint8_t len, bool isTelemetry = true);
